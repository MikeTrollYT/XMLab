...
const xsdExercises = [
  {
    ...
    requirements: [
      ...
      { label: 'Esquema', detail: '<xsd:schema> válido' },
    ],
    hint: 'Empieza por <xsd:element name="libro"> y dentro usa <xsd:sequence> para titulo, autor y paginas.',
  ...
  },
  {
    ...
    hint: 'Puedes usar xsd:string, xsd:int, xsd:string y xsd:boolean para los elementos del ejemplo.',
  ...
  },
  {
    ...
    hint: 'Recuerda definir <xsd:attribute name="id"> dentro del tipo complejo de producto.',
  ...
  },
  {
    ...
    hint: 'Para fecha puedes usar xsd:date y mantener el orden exacto de la secuencia.',
  ...
  },
  {
    ...
    hint: 'Define un <xsd:simpleType> con <xsd:restriction base="xsd:integer"> y usa minInclusive value="0" y maxInclusive value="10".',
  ...
  },
  {
    ...
    requirements: [
      ...
      { label: 'Faceta', detail: 'xsd:enumeration' },
    ],
    hint: 'Define un <xsd:simpleType> para tipo con <xsd:restriction base="xsd:string"> y tres <xsd:enumeration value="..."/>.',
    sourceXml: `<?xml version="1.0" encoding="UTF-8"?>\n<vehiculo>\n  <marca>Toyota</marca>\n  <modelo>Yaris</modelo>\n  <tipo>electrico</tipo>\n  <año>2023</año>\n</vehiculo>`,
    validate: {
      expectedRoot: 'vehiculo',
      requiredElementNames: ['marca', 'modelo', 'tipo', 'año'],
  ...
  },
  {
    ...
    requirements: [
      ...
      { label: 'Facetas', detail: 'minInclusive y maxInclusive' },
      { label: 'Booleano', detail: 'activo: xsd:boolean' },
    ],
    hint: 'Define un simpleType para salario con restriction base="xsd:decimal". Para activo usa directamente type="xsd:boolean".',
  ...
  },
  {
    ...
    hint: '¡El más complejo! Dos niveles con atributos. Cada libro es un complexType con su sequence y su propio xsd:attribute isbn.',
